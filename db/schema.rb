...
ActiveRecord::Schema.define(version: 20_221_117_133_430) do
  ...
  create_table 'employees', force: :cascade do |t|
    ...
    t.index %w[invited_by_type invited_by_id], name: 'index_employees_on_invited_by'
  ...
  create_table 'menu_items', force: :cascade do |t|
    ...
    t.index %w[menu_itemable_type menu_itemable_id], name: 'index_menu_items_on_menu_itemable'
  end
